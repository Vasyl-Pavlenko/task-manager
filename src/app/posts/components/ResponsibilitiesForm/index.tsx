...
export const ResponsibilitiesForm: FC = () => {
  ...
  const handleRemovePost = () => {
    ...
    toast.warning(`${postsList[currentPost].name} was deleted successfully!`);
  }
    ...
    >
      <div className={sass.responsibilitiesContent}>
        <div className={sass.checkboxGroup}>
          <h3 className={sass.groupTitle}>
            Торговля
          </h3>

          <CheckBox
            handleChangeCheckbox={handleChangeCheckbox}
            text="Продавать продукт"
            name="commerce"
        ...
        <div className={sass.checkboxGroup}>
          ...
          <CheckBox
            ...
            text="Закупать сырье"
            name="production"
            value="purchase-raw-materials"
          />

          <CheckBox
            handleChangeCheckbox={handleChangeCheckbox}
            text="Назначать рабочих"
            name="production"
        ...
        <div className={sass.checkboxGroup}>
          ...
          <CheckBox
            handleChangeCheckbox={handleChangeCheckbox}
            text="Назначать должности"
            name="management"
            value="assign-positions"
          />

          <CheckBox
            handleChangeCheckbox={handleChangeCheckbox}
            text="Выгонять из банды"
            name="management"
            value="kick-from-band"
          />
        </div>
      </div>
